...
const Keyboard = {
    ...
    toggleNumericAndTextKeyborad(manual) {
        let firstkeyboard = this.elements.main.querySelector(".keyboard__keys > div:first-child");

        if (this.properties.keyboard_type == 'number' || manual == 'number') {
            firstkeyboard.style.left = "-100%";
            this.elements.main.querySelector(".keyboard__keys > div:last-child").style.left = "0";
        }
        if (this.properties.keyboard_type == 'password' || manual == 'password') {
            firstkeyboard.style.left = "0%";
            this.elements.main.querySelector(".keyboard__keys > div:last-child").style.left = "100%";
        }
    },
};
